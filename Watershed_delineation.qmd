...
A **watershed**, often also referred to as a **catchment** or **drainage basin**, is a landscape unit over which the **hydrological balance** (@eq-waterbalance) can be determined (measured or computed). It is the area draining to a **common point**. Watershed delineation is creating a boundary representing the contributing area for a particular point/outlet.
...
### Hydrological Balance {#sec-hydrological-balance-theory .unnumbered}
