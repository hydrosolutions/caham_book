...
Make sure that you have downloaded storede the following climate data file [ERA5_Nauvalisoy_1981_2013.csv](https://www.dropbox.com/s/9mm6x8cc78rr29i/ERA5_Nauvalisoy_1981_2013.csv?dl=1) for Nauvalisoy River on your computer. 
...
Select the file that you downloaded before. If you don't see the file in your file browser, make sure the file ending .csv is selected in the file browser (see @fig-open-database-tab-csv).
...
Make sure that the following file [synthetic_discharge_Nauvalisoy_river_for_calibration_exercise.csv](https://www.dropbox.com/s/gw968m3bs43kzse/synthetic_discharge_Nauvalisoy_river_for_calibration_exercise.csv?dl=1) is available on your computer. 

Now, open the file in a spreadsheet software, e.g. Excel, Numbers, Google Sheets or OpenOffice Calc and select the rows containing dates and values (@fig-copy-spreadsheet-data). Press *Control+C* or perform a right-click with the mouse and choose copy. 
