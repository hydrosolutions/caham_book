...
```{r}
#| include: true
#| label: load_data-gunt-river-basin
#| message: false
#| warning: false
...
We can in fact compute these changes with high resolution daily climate fields that are nowadays available (see @karger_2017, @karger_2020 and @karger_2021 and also more on these in @sec-data). @fig-snow-cover-fraction-change-chirchik-river-basin shows the corresponding results.

![Changes in fractional snow cover in the in the Western Tien Shan mountains, including the Chirchik River basin. Shown are percentage changes over the period 1980 - 2011. Changes in snow cover fraction was computed using CHELSA V21 daily precipitation and temperature with a liquid-solid temperature threshold value of 1 deg. C.. (\@karger_2017, \@karger_2020, \@karger_2021).](/images/example_river_basins/snowcover_fraction_change_chirchik_lr.jpg){#fig-snow-cover-fraction-change-chirchik-river-basin}
