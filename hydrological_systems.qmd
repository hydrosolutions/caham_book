...
Using the aridity index $\phi$ for classification, the main zones of runoff formation are shown in @fig-zones-of-runoff-formation. The aridity index denotes the fraction of long-term precipitation, i.e. the **total atmospheric water supply**, divided by the long-term mean potential evapotranspiration which is the **total atmospheric water demand** (see also the [Chapter Long-term Water Balance Modeling](#sec-budyko-modeling) for more information).

![Regions where the aridity index \phi indicate humid conditions are colored blue $(\phi < 0.76)$. Regions where the aridity index is $\phi \gt 0.76$ and $\phi \lt 1.3$ indicating equidistant regions are colored green. These regions are the main zones of runoff formation. Climatology data are from @karger_2021 to compute the aridity index. For the definition of the humid and equidistant zones, we use @mcvicar_2012.](/images/hydrology_of_central_asia/10_central_asia_low_aridity.jpg){#fig-zones-of-runoff-formation}
