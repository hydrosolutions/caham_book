...
Comparing @fig-zones-of-runoff-formation with @fig-central-asia-high-aridity, it is evident that the bulk of the domain is either arid or hyperarid and that the mountains are the regions where the annually renewable water resources are formed. In fact, these humid regions resemble floating islands in an enormous sea of aridity.
