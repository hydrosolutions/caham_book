...
For a catchment, annual mean $E$ and $Q$ are governed by total *water supply* $P$ and the total available energy which is normally expressed as potential evaporation $E_{pot}$ and which denotes the (atmospheric) *water demand*. If $E_{pot}$ is small, the discharge $Q$ is normally bigger than evaporation $E$. Similarly, if the available radiative energy is very high, the water demand $E_{pot}$ is very large and $Q \ll E$ [@ARORA2002164]. $E_{pot}$ and $P$ are thus the key determinants of annual or longer timescale runoff and evaporation rates. Michael Budyko has termed the ratio $E_{pot} / P$ aridity index [@budyko_1974].
