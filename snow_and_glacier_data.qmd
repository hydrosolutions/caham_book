...
## Introduction
The runoff of the rivers Syr Darya and Amu Darya consists of 65%-75% snow melt, 23% precipitation and 2-8% glacier melt approximately [@armstrong_runoff_2019]. In smaller, highly glaciated catchments, the glacier contribution to discharge can be more important [@khanal_variable_2021]. Generally, the cryosphere is a major contributor to the water balance in Central Asia [@barandun_state_2020]. While glacier runoff is a small contributor to the annual runoff, it is seasonally important as it covers the irrigation demand in summer, when snow melt is over [@kaser_contribution_2010]. 
...
```{r swe, warning=FALSE, message=FALSE, message=FALSE}
#| fig.cap = "Snow water equivalent map of October 1, 1998 (source; HMASR)." 
