...
Familiarize yourself with the [Geospatial Data](#sec-geospatial-data). Do the catchment characterization of the basin you selected to work on by filling in the Table @tbl-example-basin-characterization below. If you have downloaded the entire folder on your local drive, you already have all the data for the analysis.
