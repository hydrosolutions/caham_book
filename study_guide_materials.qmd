...
Read the chapters on [discharge station data](##sec-discharge-station-data) and [climate data](#sec-climate-data) and, together with your colleague, perform a discharge characterization of your basin following the video tutorial. 
...
Read the chapter on [Model calibration and validation](#section-model-calibration-and-validation) and go through the example of the Nauvalisoy catchment which illustrates the iterative model refinement process.   
